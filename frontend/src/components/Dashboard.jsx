...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchCurrentUser = async () => {
      try {
        ...
        const res = await fetch(`https://fulltoss-assign.onrender.com/auth/details`, {
          headers: {
    ...
    const fetchProducts = async () => {
      try {
        const token = localStorage.getItem('fulltossaccesstoken');
        const res = await fetch(`https://fulltoss-assign.onrender.com/user/getproducts`, {
    ...
    const fetchCart = async () => {
      try {
        const token = localStorage.getItem('fulltossaccesstoken');
        const res = await fetch(`https://fulltoss-assign.onrender.com/user/getcart`, {
          headers: { Authorization: `Bearer ${token}` },
          credentials: 'include',
        });
        const data = await res.json();
  ...
  const handleAddToCart = async (productId) => {
    try {
      ...
      const token = localStorage.getItem('fulltossaccesstoken');
      const res = await fetch(`https://fulltoss-assign.onrender.com/user/addtocart`, {
        method: 'POST',
        headers: {
  ...
  const handleRemoveFromCart = async (productId) => {
    try {
      ...
      const token = localStorage.getItem('fulltossaccesstoken');
      const res = await fetch(`https://fulltoss-assign.onrender.com/user/deletefromcart`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
